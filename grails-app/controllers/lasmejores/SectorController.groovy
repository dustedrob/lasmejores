...
class SectorController {
    ...
    def save(Sector sectorInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'sectorInstance.label', default: 'Sector'), sectorInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'sectorInstance.label', default: 'Sector'), params.id])
                redirect action: "index", method: "GET"
            }
