		...
		<div id="list-sector" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="idSector" title="${message(code: 'sector.idSector.label', default: 'Id Sector')}" />
				...
				<g:each in="${sectorInstanceList}" status="i" var="sectorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${sectorInstance.id}">${fieldValue(bean: sectorInstance, field: "idSector")}</g:link></td>
